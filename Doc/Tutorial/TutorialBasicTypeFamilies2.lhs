...
>   bdName :: f :** TableRecordField String SqlText NN Req
> , bdDay  :: f :** TableRecordField Day    SqlDate NN Req
> }
...
>          , Default p (a :** TableRecordField Day    SqlDate NN Req)
>                      (b :** TableRecordField Day    SqlDate NN Req)) =>
